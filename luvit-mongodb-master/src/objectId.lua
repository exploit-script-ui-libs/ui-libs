...
local _os = require('jit').os
local m_id = _os == 'Windows' and assert(io.popen("ver")):read("*all"):gsub("\n", "") or assert(io.popen("uname -n")):read("*l")
local machineid = openssl.digest.digest("md5", m_id):sub(1, 3)
